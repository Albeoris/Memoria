...
namespace Memoria
{
    public class FieldCharacterNames
    {
        public static FieldCharacterNames GetCurrent()
        {
            String localizationSymbol = Localization.GetSymbol();
            FieldCharacterNames result = Create(localizationSymbol);
            result.Initialize();
            return result;
        }

        private static FieldCharacterNames Create(String localizationSymbol)
        {
            if (localizationSymbol == "US")
                return new UsFieldCharacterNames();

            return new FieldCharacterNames();
        }
