...
namespace Memoria
{
    public sealed class CharacterBuilder
    {
        ...
        private void CreateModel(Actor actor, ICharacterDescriptor desc)
        {
            ...
            String modelName = FF9BattleDB.GEO[modelId];
        ...
        private void SetActorAnimation(Actor actor, ICharacterDescriptor desc)
        {
            ...
            AnimationFactory.AddAnimWithAnimatioName(model, FF9DBAll.AnimationDB[actor.idle]);
            AnimationFactory.AddAnimWithAnimatioName(model, FF9DBAll.AnimationDB[actor.walk]);
            AnimationFactory.AddAnimWithAnimatioName(model, FF9DBAll.AnimationDB[actor.run]);
            AnimationFactory.AddAnimWithAnimatioName(model, FF9DBAll.AnimationDB[actor.turnl]);
            AnimationFactory.AddAnimWithAnimatioName(model, FF9DBAll.AnimationDB[actor.turnr]);
        }
