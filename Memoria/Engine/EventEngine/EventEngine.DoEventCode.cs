    ...
    public Int32 DoEventCode()
    {
        ...
        switch (eventCodeBinary)
        {
            ...
            case EBin.event_code_binary.MODEL:
                ...
                if (this.gMode == 1)
                {
                    String str = FF9BattleDB.GEO[(Int32)po.model];
                ...
                {
                    po.go = ModelFactory.CreateModel(FF9BattleDB.GEO[(Int32)po.model], false);
            ...
            case EBin.event_code_binary.AIDLE:
                ...
                AnimationFactory.AddAnimWithAnimatioName(actor1.go, FF9DBAll.AnimationDB[(Int32)actor1.idle]);
            ...
            case EBin.event_code_binary.AWALK:
                ...
                AnimationFactory.AddAnimWithAnimatioName(actor1.go, FF9DBAll.AnimationDB[(Int32)actor1.walk]);
                return 0;
            case EBin.event_code_binary.ARUN:
                actor1.run = (UInt16)this.getv2();
                AnimationFactory.AddAnimWithAnimatioName(actor1.go, FF9DBAll.AnimationDB[(Int32)actor1.run]);
                return 0;
            ...
            case EBin.event_code_binary.ATURNL:
                ...
                AnimationFactory.AddAnimWithAnimatioName(actor1.go, FF9DBAll.AnimationDB[(Int32)actor1.turnl]);
                return 0;
            case EBin.event_code_binary.ATURNR:
                actor1.turnr = (UInt16)this.getv2();
                AnimationFactory.AddAnimWithAnimatioName(actor1.go, FF9DBAll.AnimationDB[(Int32)actor1.turnr]);
                return 0;
            ...
            case EBin.event_code_binary.CLEARSTATUS:
                Int32 num70 = (Int32)this.fieldCalc.FieldRemoveStatus(FF9StateSystem.Common.FF9.player[this.chr2slot(this.getv1())], (Byte)this.getv1());
                return 0;
            ...
            case EBin.event_code_binary.SETHP:
                Int32 num81 = this.chr2slot(this.getv1());
                if (num81 >= 0 && num81 < 9)
                {
                    Int32 index4 = num81;
                    PLAYER player = FF9StateSystem.Common.FF9.player[index4];
                    Int32 num13 = this.getv2();
                    if (num13 > (Int32)player.max.hp)
                        num13 = (Int32)player.max.hp;
                    player.cur.hp = (UInt16)num13;
                    FF9StateSystem.Common.FF9.player[index4] = player;
                }
                return 0;
            case EBin.event_code_binary.SETMP:
                Int32 num82 = this.chr2slot(this.getv1());
                if (num82 >= 0 && num82 < 9)
                {
                    Int32 index4 = num82;
                    PLAYER player = FF9StateSystem.Common.FF9.player[index4];
                    Int32 num13 = this.getv2();
                    if (num13 > (Int32)player.max.mp)
                        num13 = (Int32)player.max.mp;
                    player.cur.mp = (Int16)num13;
                    FF9StateSystem.Common.FF9.player[index4] = player;
                }
                return 0;
