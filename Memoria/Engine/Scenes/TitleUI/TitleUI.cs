...
public class TitleUI : UIScene
{
    ...
    private void Awake()
    {
        ...
        {
            textAsset = AssetManager.Load<TextAsset>("EmbeddedAsset/Manifest/Text/StaffCredits_Amazon.txt", false);
        }
        else if (FF9StateSystem.MobilePlatform)
        {
            textAsset = AssetManager.Load<TextAsset>("EmbeddedAsset/Manifest/Text/StaffCredits_Mobile.txt", false);
        }
        else if (FF9StateSystem.EStorePlatform)
        {
            textAsset = AssetManager.Load<TextAsset>("EmbeddedAsset/Manifest/Text/StaffCredits_EStore.txt", false);
        }
        else
        {
            textAsset = AssetManager.Load<TextAsset>("EmbeddedAsset/Manifest/Text/StaffCredits_Steam.txt", false);
        }
        if (textAsset != null)
        {
            this.StaffLabel.text = textAsset.text;
        }
        ...
        textAsset = AssetManager.Load<TextAsset>("EmbeddedAsset/Manifest/Text/License_" + str + ".txt", false);
        if (textAsset != null)
        {
