    ...
    public class VorbisReader : IDisposable
    {
            ...
            : this()
        {
            ...
            if (!LoadContainer(oggContainer))
            {
                ...
                throw new InvalidOperationException("Could not determine container type!");
            }
            _containerReader = oggContainer;

            if (_decoders.Count == 0) throw new InvalidOperationException("No Vorbis data found!");
        }
            ...
            : this()
        {
            ...
            {
                throw new InvalidOperationException("Container did not initialize!");
            }
            ...
            : this()
        {
            ...
            NewStream(this, ea);
            if (ea.IgnoreStream) throw new InvalidOperationException("No Vorbis data found!");
        }
