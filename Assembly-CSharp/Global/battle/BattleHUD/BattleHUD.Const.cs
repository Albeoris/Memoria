    ...
    private static BattleCommandId GetCommandFromCommandIndex(ref CommandMenu commandIndex, Int32 playerIndex)
    {
        ...
        switch (commandIndex)
        {
            ...
            case CommandMenu.Defend:
                ...
                if (Configuration.Mod.TranceSeek) // Trance SEEK - Change Steiner/Amarant's Defend Command => [DV] Will be removed when commands can be changed via AbilityFeatures
                {
