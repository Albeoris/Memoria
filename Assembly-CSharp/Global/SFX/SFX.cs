...
public static class SFX
{
    ...
    public static void InitBtlData(ref BTL_DATA_INIT init, BTL_DATA btl)
    {
        ...
        init.bi_slot_no = (Byte)Math.Min(btl.bi.slot_no, (Int32)CharacterOldIndex.Beatrix);
        init.bi_slave = btl.bi.slave;
        init.bi_line_no = btl.bi.line_no;
        if (btl.bi.player != 0)
        {
            init.player_serial_no = (Byte)Math.Min((Int32)btl_util.getSerialNumber(btl), (Int32)CharacterSerialNumber.BEATRIX);
