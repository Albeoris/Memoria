...
public class PosObj : Obj
{
    ...
    public void copy(PosObj po)
    {
        ...
        this.attachTargetUid = po.attachTargetUid;
    ...
    {
        return (Int16)(this.meshflags & (UInt64)(1L << (mesh & 31)));
    }
    ...
    public Int32 geoGetMeshCount()
    {
        if (this.meshIsRendering == null)
            return 0;
        return this.meshIsRendering.Length;
    }
    ...
    public Int32 attachTargetUid = -1;
