		...
		for (Int32 i = 0; i < text.Length; i++)
		{
			...
			else
			{
				...
				if (text3 == "[" + NGUIText.IconVar)
				{
					...
					if (flag)
					{
						num += NGUIText.GetTextWidthFromFF9Font(this, FF9TextTool.RemoveOpCode(text4));
					}
					else
					{
						num += FF9UIDataTool.GetIconSize(oneParameterFromTag).x;
					}
				}
				else if (text3 == "[" + NGUIText.CustomButtonIcon || text3 == "[" + NGUIText.ButtonIcon || text3 == "[" + NGUIText.JoyStickButtonIcon || text3 == "[" + NGUIText.KeyboardButtonIcon)
				{
					...
					String text5 = text.Substring(i + 6, num2 - i - 6);
				...
				else if (text3 == "[" + NGUIText.MobileIcon)
				{
					...
					num += FF9UIDataTool.GetIconSize(oneParameterFromTag2).x;
				}
				else if (NGUIText.nameKeywordList.Contains(text3.Remove(0, 1)))
				{
					...
					{
						text8 = FF9StateSystem.Common.FF9.party.member[0].name;
						text2 += text8;
						text7 = "Party 1:" + text8;
					}
					else if (a == NGUIText.Party2)
					{
						text8 = FF9StateSystem.Common.FF9.party.member[1].name;
						text2 += text8;
						text7 = "Party 2:" + text8;
					}
					else if (a == NGUIText.Party3)
					{
						text8 = FF9StateSystem.Common.FF9.party.member[2].name;
						text2 += text8;
						text7 = "Party 3:" + text8;
					}
					else if (a == NGUIText.Party4)
					{
						text8 = FF9StateSystem.Common.FF9.party.member[3].name;
						text2 += text8;
						text7 = "Party 4:" + text8;
					}
					num += NGUIText.GetTextWidthFromFF9Font(this, text8);
				}
				else if (text3 == "[" + NGUIText.NumberVar)
				{
					Int32 num4 = 0;
					Int32 oneParameterFromTag3 = NGUIText.GetOneParameterFromTag(text, i, ref num4);
					num2 = text.IndexOf(']', i + 4);
					Int32 num5 = PersistenSingleton<EventEngine>.Instance.eTb.gMesValue[oneParameterFromTag3];
					text2 += num5.ToString();
					num += NGUIText.GetTextWidthFromFF9Font(this, num5.ToString());
				}
				else if (text3 == "[" + NGUIText.MessageTab)
				{
					Int32 oneParameterFromTag4 = NGUIText.GetOneParameterFromTag(text, i, ref num2);
					num += (Single)(oneParameterFromTag4 * 3);
					String text6 = text2;
					text2 = String.Concat(new Object[]
					{
						text6,
				...
				else if (text3 == "[" + NGUIText.MessageFeed)
				{
					...
					num += (Single)(oneParameterFromTag5 * 3);
					String text6 = text2;
					text2 = String.Concat(new Object[]
					{
						text6,
						text3,
						"=",
						oneParameterFromTag5,
						"]"
					});
				}
				else if (text3 == "[" + NGUIText.SpacingY)
				{
					this.spacingY = NGUIText.GetOneParameterFromTag(text, i, ref num2);
				}
				if (num2 == i)
				{
					text2 += text[i];
