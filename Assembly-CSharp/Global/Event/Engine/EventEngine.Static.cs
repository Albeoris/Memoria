...
public partial class EventEngine : PersistenSingleton<EventEngine>
{
    ...
    public const Int32 FLOW_STATE_EXEC = 0;
    public const Int32 FLOW_STATE_WAIT = 1;
    public const Int32 FLOW_STATE_DELETE = 2;
    public const Int32 FLOW_STATE_JUMP_BATTLE = 3;
    public const Int32 FLOW_STATE_JUMP_FIELD = 4;
    public const Int32 FLOW_STATE_JUMP_WORLD_MAP = 5;
    public const Int32 FLOW_STATE_STOP = 6;
    public const Int32 FLOW_STATE_QUADMIST = 7;
    public const Int32 FLOW_STATE_GAMEOVER = 8;
    ...
    public const Int32 SIZE_OF_OBJ = 20;
    public const Int32 SIZE_OF_QUAD = 56;
    public const Int32 SIZE_OF_ACTOR = 160;
    ...
    public const Int32 UID_OFFSET_SEQ = 64;
    public const Int32 UID_OFFSET_SPEC = 128;
