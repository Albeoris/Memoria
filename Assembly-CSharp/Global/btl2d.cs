...
public class btl2d
{
	...
	public static void Btl2dInit()
	{
		...
		{
			entry[(Int32)num].BtlPtr = (BTL_DATA)null;
		}
	}
	...
	{
		Byte b = 0;
		UInt16 fig_stat_info = (UInt16)pBtl.fig_stat_info;
		if (pBtl.bi.disappear == 0)
		{
	...
	public static BTL2D_ENT GetFreeEntry(BTL_DATA pBtl)
	{
		...
		BTL2D_ENT btl2D_ENT = btl2d_work_set.Entry[(Int32)num];
		...
		btl2D_ENT2.Yofs = (SByte)((Int32)btl2D_ENT2.Yofs + 4);
	...
	private static void Btl2dStatIcon()
	{
		...
		for (BTL_DATA next = ff9Battle.btl_list.next; next != null; next = next.next)
		{
			if (next.bi.disappear == 0)
			{
				...
				{
					if (((UInt16)btl2d_work_set.OldDisappear & next.btl_id) == 0)
					{
						UInt32 num = next.stat.cur | next.stat.permanent;
						if ((num & 256u) == 0u)
						{
							if ((num & 588974138u) != 0u)
							{
								if (next.bi.player == 0 || !btl_mot.checkMotion(next, 17))
								{
									...
									if (next.bi.player != 0)
									{
										num4 = (Int16)FF9StateSystem.Common.FF9.player[(Int32)next.bi.slot_no].info.serial_no;
										array = btl2d.wBonePC[(Int32)num4];
										array2 = btl2d.wYofsPC[(Int32)num4];
										array3 = btl2d.wZofsPC[(Int32)num4];
									}
									else
									{
										ENEMY_TYPE et = ff9Battle.enemy[(Int32)next.bi.slot_no].et;
										array = et.icon_bone;
										array2 = et.icon_y;
										array3 = et.icon_z;
									}
									...
									for (;;)
									{
										...
										if ((num & stat_ICON_TBL.Mask) != 0u)
										{
											...
											{
												Int16 num7 = (Int16)((Int32)array2[(Int32)stat_ICON_TBL.Pos] << 4);
												Int16 num8 = (Int16)((Int32)array3[(Int32)stat_ICON_TBL.Pos] << 4);
												if ((next.flags & geo.GEO_FLAGS_SCALE) != 0)
												{
													num7 = (Int16)((Int32)((Single)num7 * next.gameObject.transform.localScale.y));
													num8 = (Int16)((Int32)((Single)num8 * next.gameObject.transform.localScale.z));
												}
												Vector3 position = next.gameObject.transform.GetChildByName("bone" + array[(Int32)stat_ICON_TBL.Pos].ToString("D3")).position;
												Vector3 pos;
												pos.x = position.x + (Single)((Int32)num8 * num2 >> 12);
												pos.y = position.y - (Single)num7;
												pos.z = position.z + (Single)((Int32)num8 * num3 >> 12);
												if (stat_ICON_TBL.Type != 0)
												{
													rot.y = 0f;
													HonoluluBattleMain.battleSPS.UpdateBtlStatus(next, stat_ICON_TBL.Mask, pos, rot, (Int32)btl2d_work_set.Timer);
												}
												else
												{
													Int32 ang = (Int32)stat_ICON_TBL.Ang;
													if (ang != 0)
													{
														Int32 num9 = (Int32)(next.rot.eulerAngles.y / 360f * 4095f);
														num9 = (num9 + 3072 & 4095);
														rot.y = (Single)num9 / 4095f * 360f;
													}
													else
													{
														rot.y = 0f;
	...
	{
		p.BaseStream.Seek((Int64)index, SeekOrigin.Begin);
		return p.ReadUInt16();
	}
	...
	private static void Btl2dStatCount()
	{
		...
		{
			new btl2d.STAT_CNT_TBL(134217728u, 11, 0),
			new btl2d.STAT_CNT_TBL(2147483648u, 15, 1)
		};
		FF9StateBattleSystem ff9Battle = FF9StateSystem.Battle.FF9Battle;
		UInt32 num = 2281701376u;
		Int16 num2 = 2;
		for (BTL_DATA next = ff9Battle.btl_list.next; next != null; next = next.next)
		{
			if (next.bi.disappear == 0)
			{
				if ((next.flags & geo.GEO_FLAGS_CLIP) == 0)
				{
					if (((UInt16)ff9Battle.btl2d_work_set.OldDisappear & next.btl_id) == 0)
					{
						UInt32 cur = next.stat.cur;
						if ((cur & 256u) == 0u)
						{
							if ((cur & num) != 0u)
							{
								...
								if (next.bi.player != 0)
								{
									num3 = (Int16)FF9StateSystem.Common.FF9.player[(Int32)next.bi.slot_no].info.serial_no;
									num4 = (Int16)btl2d.wBonePC[(Int32)num3][5];
									num5 = (Int16)btl2d.wYofsPC[(Int32)num3][5];
								}
								else
								{
									ENEMY_TYPE et = ff9Battle.enemy[(Int32)next.bi.slot_no].et;
									num4 = (Int16)et.icon_bone[5];
									num5 = (Int16)et.icon_y[5];
								}
								if ((next.flags & geo.GEO_FLAGS_SCALE) != 0)
								{
									num5 = (Int16)((Int32)((Single)num5 * next.gameObject.transform.localScale.y));
								}
								Transform childByName = next.gameObject.transform.GetChildByName("bone" + num4.ToString("D3"));
								Int32 num6 = -((Int32)num5 << 4);
								Int32 num7 = 0;
								num3 = num2;
								for (;;)
								{
									...
									if ((cur & stat_CNT_TBL.Mask) != 0u)
									{
										...
										Int16 num9;
										if ((num9 = next.stat.cnt.conti[(Int32)stat_CNT_TBL.Idx]) < 0)
										{
											break;
										}
										Int16 num10 = (Int16)next.cur.at_coef;
										...
										{
											Byte b = (Byte)(((Int32)num4 << 4) + 32);
											num12 = ((Int32)b << 16 | (Int32)b << 8 | (Int32)b);
										}
										else
										{
											num12 = 16777216;
										}
										num12 |= (Int32)num11 << 24;
										num4 = (Int16)(num4 + 1);
										if (num4 > 10)
										{
											num4 = 10;
	...
	{
		new btl2d.STAT_ICON_TBL(65536u, 0u, (BinaryReader)null, 0, 1, 0, 0),
		new btl2d.STAT_ICON_TBL(2u, 0u, (BinaryReader)null, 0, 1, 0, 0),
		new btl2d.STAT_ICON_TBL(1048576u, 0u, (BinaryReader)null, 0, Byte.MaxValue, 1, 0),
		new btl2d.STAT_ICON_TBL(524288u, 0u, (BinaryReader)null, 0, Byte.MaxValue, 1, 0),
		new btl2d.STAT_ICON_TBL(131072u, 0u, (BinaryReader)null, 0, Byte.MaxValue, 0, 1),
		new btl2d.STAT_ICON_TBL(16777216u, 0u, (BinaryReader)null, 1, 1, 0, 0),
		new btl2d.STAT_ICON_TBL(33554432u, 0u, (BinaryReader)null, 1, 1, 0, 0),
		new btl2d.STAT_ICON_TBL(536870912u, 1u, (BinaryReader)null, 1, 1, 0, 0),
		new btl2d.STAT_ICON_TBL(8u, 0u, (BinaryReader)null, 2, Byte.MaxValue, 1, 1),
		new btl2d.STAT_ICON_TBL(16u, 0u, (BinaryReader)null, 3, 2, 0, 0),
		new btl2d.STAT_ICON_TBL(32u, 0u, (BinaryReader)null, 4, Byte.MaxValue, 1, 0),
		new btl2d.STAT_ICON_TBL(2048u, 0u, (BinaryReader)null, 4, 1, 0, 0)
	};
	...
	{
		public STAT_CNT_TBL(UInt32 mask, Int16 idx, UInt16 col)
		{
			this.Mask = mask;
			this.Idx = idx;
			this.Col = col;
	...
	{
		public STAT_ICON_TBL(UInt32 mask, UInt32 mask2, BinaryReader spr, Byte pos, Byte abr, Byte type, Byte ang)
		{
			this.Mask = mask;
			this.Mask2 = mask2;
			this.Spr = spr;
