// $ANTLR 3.3.0.7239 NCalc\\Grammar\\NCalc.g 2011-08-08 11:08:01
...
public partial class NCalcParser : Antlr.Runtime.Parser
{
	...
	public override string GrammarFileName { get { return "NCalc\\Grammar\\NCalc.g"; } }
	...
	// NCalc\\Grammar\\NCalc.g:77:1: ncalcExpression returns [LogicalExpression value] : logicalExpression EOF ;
	...
	public NCalcParser.ncalcExpression_return ncalcExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:78:2: ( logicalExpression EOF )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:78:4: logicalExpression EOF
				{
	...
	// NCalc\\Grammar\\NCalc.g:81:1: logicalExpression returns [LogicalExpression value] : left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )? ;
	...
	private NCalcParser.logicalExpression_return logicalExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:82:2: (left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )? )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:82:4: left= conditionalExpression ( '?' middle= conditionalExpression ':' right= conditionalExpression )?
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					DebugLocation(82, 57);
					// NCalc\\Grammar\\NCalc.g:82:57: ( '?' middle= conditionalExpression ':' right= conditionalExpression )?
					int alt1 = 2;
					try
					{
						DebugEnterSubRule(1);
						...
						switch (alt1)
						{
							case 1:
								DebugEnterAlt(1);
								// NCalc\\Grammar\\NCalc.g:82:59: '?' middle= conditionalExpression ':' right= conditionalExpression
								{
									DebugLocation(82, 59);
	...
	// NCalc\\Grammar\\NCalc.g:85:1: conditionalExpression returns [LogicalExpression value] : left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )* ;
	...
	private NCalcParser.conditionalExpression_return conditionalExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:89:2: (left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:89:4: left= booleanAndExpression ( ( '||' | 'or' ) right= conditionalExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					retval.value = (left != null ? left.value : default(LogicalExpression));
					DebugLocation(89, 56);
					// NCalc\\Grammar\\NCalc.g:89:56: ( ( '||' | 'or' ) right= conditionalExpression )*
					try
					{
						DebugEnterSubRule(2);
						while (true)
						{
							...
							switch (alt2)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:90:4: ( '||' | 'or' ) right= conditionalExpression
									{
										DebugLocation(90, 4);
	...
	// NCalc\\Grammar\\NCalc.g:95:1: booleanAndExpression returns [LogicalExpression value] : left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )* ;
	...
	private NCalcParser.booleanAndExpression_return booleanAndExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:99:2: (left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:99:4: left= bitwiseOrExpression ( ( '&&' | 'and' ) right= bitwiseOrExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					retval.value = (left != null ? left.value : default(LogicalExpression));
					DebugLocation(99, 55);
					// NCalc\\Grammar\\NCalc.g:99:55: ( ( '&&' | 'and' ) right= bitwiseOrExpression )*
					try
					{
						DebugEnterSubRule(3);
						while (true)
						{
							...
							switch (alt3)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:100:4: ( '&&' | 'and' ) right= bitwiseOrExpression
									{
										DebugLocation(100, 4);
	...
	// NCalc\\Grammar\\NCalc.g:105:1: bitwiseOrExpression returns [LogicalExpression value] : left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )* ;
	...
	private NCalcParser.bitwiseOrExpression_return bitwiseOrExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:109:2: (left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:109:4: left= bitwiseXOrExpression ( '|' right= bitwiseOrExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:109:56: ( '|' right= bitwiseOrExpression )*
					try
					{
						DebugEnterSubRule(4);
						while (true)
						{
							...
							switch (alt4)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:110:4: '|' right= bitwiseOrExpression
									{
										DebugLocation(110, 4);
	...
	// NCalc\\Grammar\\NCalc.g:115:1: bitwiseXOrExpression returns [LogicalExpression value] : left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )* ;
	...
	private NCalcParser.bitwiseXOrExpression_return bitwiseXOrExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:119:2: (left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:119:4: left= bitwiseAndExpression ( '^' right= bitwiseAndExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:119:56: ( '^' right= bitwiseAndExpression )*
					try
					{
						DebugEnterSubRule(5);
						while (true)
						{
							...
							switch (alt5)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:120:4: '^' right= bitwiseAndExpression
									{
										DebugLocation(120, 4);
	...
	// NCalc\\Grammar\\NCalc.g:125:1: bitwiseAndExpression returns [LogicalExpression value] : left= equalityExpression ( '&' right= equalityExpression )* ;
	...
	private NCalcParser.bitwiseAndExpression_return bitwiseAndExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:129:2: (left= equalityExpression ( '&' right= equalityExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:129:4: left= equalityExpression ( '&' right= equalityExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:129:54: ( '&' right= equalityExpression )*
					try
					{
						DebugEnterSubRule(6);
						while (true)
						{
							...
							switch (alt6)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:130:4: '&' right= equalityExpression
									{
										DebugLocation(130, 4);
	...
	// NCalc\\Grammar\\NCalc.g:135:1: equalityExpression returns [LogicalExpression value] : left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )* ;
	...
	private NCalcParser.equalityExpression_return equalityExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:139:2: (left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:139:4: left= relationalExpression ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:139:56: ( ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression )*
					try
					{
						DebugEnterSubRule(8);
						while (true)
						{
							...
							switch (alt8)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:140:4: ( ( '==' | '=' ) | ( '!=' | '<>' ) ) right= relationalExpression
									{
										DebugLocation(140, 4);
										// NCalc\\Grammar\\NCalc.g:140:4: ( ( '==' | '=' ) | ( '!=' | '<>' ) )
										int alt7 = 2;
										try
										{
											DebugEnterSubRule(7);
	...
	// NCalc\\Grammar\\NCalc.g:146:1: relationalExpression returns [LogicalExpression value] : left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )* ;
	...
	private NCalcParser.relationalExpression_return relationalExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:150:2: (left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:150:4: left= shiftExpression ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:150:51: ( ( '<' | '<=' | '>' | '>=' ) right= shiftExpression )*
					try
					{
						...
						while (true)
						{
							...
							switch (alt10)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:151:4: ( '<' | '<=' | '>' | '>=' ) right= shiftExpression
									{
										DebugLocation(151, 4);
										// NCalc\\Grammar\\NCalc.g:151:4: ( '<' | '<=' | '>' | '>=' )
										int alt9 = 4;
										try
										{
											DebugEnterSubRule(9);
	...
	// NCalc\\Grammar\\NCalc.g:159:1: shiftExpression returns [LogicalExpression value] : left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )* ;
	...
	private NCalcParser.shiftExpression_return shiftExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:163:2: (left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:163:4: left= additiveExpression ( ( '<<' | '>>' ) right= additiveExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:163:54: ( ( '<<' | '>>' ) right= additiveExpression )*
					try
					{
						...
						while (true)
						{
							...
							switch (alt12)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:164:4: ( '<<' | '>>' ) right= additiveExpression
									{
										DebugLocation(164, 4);
										// NCalc\\Grammar\\NCalc.g:164:4: ( '<<' | '>>' )
										int alt11 = 2;
										try
										{
	...
	// NCalc\\Grammar\\NCalc.g:170:1: additiveExpression returns [LogicalExpression value] : left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )* ;
	...
	private NCalcParser.additiveExpression_return additiveExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:174:2: (left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:174:4: left= multiplicativeExpression ( ( '+' | '-' ) right= multiplicativeExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:174:60: ( ( '+' | '-' ) right= multiplicativeExpression )*
					try
					{
						...
						while (true)
						{
							...
							switch (alt14)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:175:4: ( '+' | '-' ) right= multiplicativeExpression
									{
										DebugLocation(175, 4);
										// NCalc\\Grammar\\NCalc.g:175:4: ( '+' | '-' )
										int alt13 = 2;
										try
										{
	...
	// NCalc\\Grammar\\NCalc.g:181:1: multiplicativeExpression returns [LogicalExpression value] : left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )* ;
	...
	private NCalcParser.multiplicativeExpression_return multiplicativeExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:185:2: (left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:185:4: left= unaryExpression ( ( '*' | '/' | '%' ) right= unaryExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:185:52: ( ( '*' | '/' | '%' ) right= unaryExpression )*
					try
					{
						...
						while (true)
						{
							...
							switch (alt16)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:186:4: ( '*' | '/' | '%' ) right= unaryExpression
									{
										DebugLocation(186, 4);
										// NCalc\\Grammar\\NCalc.g:186:4: ( '*' | '/' | '%' )
										int alt15 = 3;
										try
										{
	...
	// NCalc\\Grammar\\NCalc.g:194:1: unaryExpression returns [LogicalExpression value] : ( primaryExpression | ( '!' | 'not' ) primaryExpression | ( '~' ) primaryExpression | '-' primaryExpression );
	...
	private NCalcParser.unaryExpression_return unaryExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:195:2: ( primaryExpression | ( '!' | 'not' ) primaryExpression | ( '~' ) primaryExpression | '-' primaryExpression )
				int alt17 = 4;
				try
				{
				...
				switch (alt17)
				{
					case 1:
						DebugEnterAlt(1);
						// NCalc\\Grammar\\NCalc.g:195:4: primaryExpression
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 2:
						DebugEnterAlt(2);
						// NCalc\\Grammar\\NCalc.g:196:8: ( '!' | 'not' ) primaryExpression
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 3:
						DebugEnterAlt(3);
						// NCalc\\Grammar\\NCalc.g:197:8: ( '~' ) primaryExpression
						{
							root_0 = (CommonTree)adaptor.Nil();

							DebugLocation(197, 8);
							// NCalc\\Grammar\\NCalc.g:197:8: ( '~' )
							DebugEnterAlt(1);
							// NCalc\\Grammar\\NCalc.g:197:9: '~'
							{
								DebugLocation(197, 9);
					...
					case 4:
						DebugEnterAlt(4);
						// NCalc\\Grammar\\NCalc.g:198:8: '-' primaryExpression
						{
							root_0 = (CommonTree)adaptor.Nil();
	...
	// NCalc\\Grammar\\NCalc.g:201:1: primaryExpression returns [LogicalExpression value] : ( '(' logicalExpression ')' |expr= value | identifier ( arguments )? );
	...
	private NCalcParser.primaryExpression_return primaryExpression()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:202:2: ( '(' logicalExpression ')' |expr= value | identifier ( arguments )? )
				int alt19 = 3;
				try
				{
				...
				switch (alt19)
				{
					case 1:
						DebugEnterAlt(1);
						// NCalc\\Grammar\\NCalc.g:202:4: '(' logicalExpression ')'
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 2:
						DebugEnterAlt(2);
						// NCalc\\Grammar\\NCalc.g:203:4: expr= value
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 3:
						DebugEnterAlt(3);
						// NCalc\\Grammar\\NCalc.g:204:4: identifier ( arguments )?
						{
							root_0 = (CommonTree)adaptor.Nil();
							...
							// NCalc\\Grammar\\NCalc.g:204:66: ( arguments )?
							int alt18 = 2;
							try
							{
								...
								switch (alt18)
								{
									case 1:
										DebugEnterAlt(1);
										// NCalc\\Grammar\\NCalc.g:204:67: arguments
										{
	...
	// $ANTLR start "value"
	// NCalc\\Grammar\\NCalc.g:207:1: value returns [ValueExpression value] : ( INTEGER | FLOAT | STRING | DATETIME | TRUE | FALSE );
	[GrammarRule("value")]
	private NCalcParser.value_return value()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:208:2: ( INTEGER | FLOAT | STRING | DATETIME | TRUE | FALSE )
				int alt20 = 6;
				try
				{
				...
				switch (alt20)
				{
					case 1:
						DebugEnterAlt(1);
						// NCalc\\Grammar\\NCalc.g:208:5: INTEGER
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 2:
						DebugEnterAlt(2);
						// NCalc\\Grammar\\NCalc.g:209:4: FLOAT
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 3:
						DebugEnterAlt(3);
						// NCalc\\Grammar\\NCalc.g:210:4: STRING
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 4:
						DebugEnterAlt(4);
						// NCalc\\Grammar\\NCalc.g:211:5: DATETIME
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 5:
						DebugEnterAlt(5);
						// NCalc\\Grammar\\NCalc.g:212:4: TRUE
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 6:
						DebugEnterAlt(6);
						// NCalc\\Grammar\\NCalc.g:213:4: FALSE
						{
							root_0 = (CommonTree)adaptor.Nil();
	...
	// NCalc\\Grammar\\NCalc.g:216:1: identifier returns [Identifier value] : ( ID | NAME );
	...
	private NCalcParser.identifier_return identifier()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:217:2: ( ID | NAME )
				int alt21 = 2;
				try
				{
				...
				switch (alt21)
				{
					case 1:
						DebugEnterAlt(1);
						// NCalc\\Grammar\\NCalc.g:217:5: ID
						{
							root_0 = (CommonTree)adaptor.Nil();
					...
					case 2:
						DebugEnterAlt(2);
						// NCalc\\Grammar\\NCalc.g:218:5: NAME
						{
							root_0 = (CommonTree)adaptor.Nil();
	...
	// NCalc\\Grammar\\NCalc.g:221:1: expressionList returns [List<LogicalExpression> value] : first= logicalExpression ( ',' follow= logicalExpression )* ;
	...
	private NCalcParser.expressionList_return expressionList()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:225:2: (first= logicalExpression ( ',' follow= logicalExpression )* )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:225:4: first= logicalExpression ( ',' follow= logicalExpression )*
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					// NCalc\\Grammar\\NCalc.g:225:62: ( ',' follow= logicalExpression )*
					try
					{
						...
						while (true)
						{
							...
							switch (alt22)
							{
								case 1:
									DebugEnterAlt(1);
									// NCalc\\Grammar\\NCalc.g:225:64: ',' follow= logicalExpression
									{
	...
	// NCalc\\Grammar\\NCalc.g:229:1: arguments returns [List<LogicalExpression> value] : '(' ( expressionList )? ')' ;
	...
	private NCalcParser.arguments_return arguments()
	{
		...
		try
		{
			...
			try
			{
				// NCalc\\Grammar\\NCalc.g:233:2: ( '(' ( expressionList )? ')' )
				DebugEnterAlt(1);
				// NCalc\\Grammar\\NCalc.g:233:4: '(' ( expressionList )? ')'
				{
					root_0 = (CommonTree)adaptor.Nil();
					...
					DebugLocation(233, 8);
					// NCalc\\Grammar\\NCalc.g:233:8: ( expressionList )?
					int alt23 = 2;
					try
					{
						...
						switch (alt23)
						{
							case 1:
								DebugEnterAlt(1);
								// NCalc\\Grammar\\NCalc.g:233:10: expressionList
								{
