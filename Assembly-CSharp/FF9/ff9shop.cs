...
namespace FF9
{
	public class ff9shop
	{
		...
		public static Int32 FF9Shop_GetDefence(Int32 part, Byte[] equip)
		{
			Int32 result = 0;
		...
		public static Int32 FF9Shop_GetType(Int32 shop_id)
		{
			return (Int32)((shop_id < 32) ? ff9buy.FF9Buy_GetType(shop_id) : 2);
		}
