    ...
    public static class TypeReplacers
    {
        ...
        private static Dictionary<String, TypeHash> InitializeRedirection()
        {
            return new Dictionary<String, TypeHash>
            {
                ...
                {"btl_cmd", TypeHash.FromBase64(@"Hukrz///////////JwAAAL9799Zq5P9aBcP1vGMraEx/7b88Xu1I80DKht09cmwiUOGGyJ3Je7rDPbxWC+GRDz/InRMLrnh8dtgxkcxVSbO4Z8osBX/s5gTTpVavYhiBaOgjeQJ/9dKZfTOtuIIRA8p3lyqsbA+YzB8tNik+zepSi9Jlilm3r67kEgFESEhMsQTpbxom6dwkvP2Y/En7TYOmP1dPsn8CQoh+MP////8=")},
                // EBing
