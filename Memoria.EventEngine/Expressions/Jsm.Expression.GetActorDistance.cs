...
namespace FF8.JSM
{
    public static partial class Jsm
    {
        ...
        {
            public sealed class GetActorDistance : IValueExpression
            {
                private readonly IValueExpression _value1;
                private readonly IValueExpression _value2;

                public GetActorDistance(IValueExpression value1, IValueExpression value2)
                {
                    _value1 = value1;
                    _value2 = value2;
                }
                ...
                public static void Evaluate(JsmExpressionEvaluator evaluator)
                {
                    ...
                    evaluator.Push(new GetActorDistance(value1, value2));
                }

                public override String ToString()
                {
                    return $"{nameof(GetActorDistance)}({_value1}, {_value2})";
                }
